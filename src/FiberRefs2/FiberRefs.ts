...
import { Lock, Semaphore } from '@/Semaphore2/Semaphore.js'
...
export function FiberRefs(
  ...
  initializing: ReadonlyMap<FiberRefId, Fiber<any, any>>,
): FiberRefs {
  ...
  const refs: FiberRefs = {
    locals,
    get,
    modify: flow(modify, Fx.scoped) as FiberRefs['modify'],
    delete: remove,
    locally,
...
export function Locals(initial: ReadonlyMap<FiberRef<any, any, any>, any> = new Map()): Locals {
