...
export namespace Fx {
  ...
  export interface Scoped<R, E, A> extends Fx<R | Scope, E, A> {}
...
export type ErrorsOf<T> = Fx.ErrorsOf<T>
export type OutputOf<T> = Fx.OutputOf<T>

function* yieldThis<T extends Fx<any, any, any>>(this: T): Generator<T, OutputOf<T>, any> {
  return yield this
}
