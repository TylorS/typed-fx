...
export const exhaustLatest = <R, E, R2, E2, A>(fx: Fx<R, E, Fx<R2, E2, A>>): Fx<R | R2, E | E2, A> =>
  exhaustMapLatest(fx, (a) => a)
...
export const exhaustMapLatestEffect: {
  ...
  (trace) =>
    <R, E, A, R2, E2, B>(
      fx: Fx<R, E, A>,
      f: (a: A) => Effect.Effect<R2, E2, B>
    ): Fx<R | R2, E | E2, B> => exhaustMapLatest(fx, (a) => fromEffect(f(a))).traced(trace)
)
