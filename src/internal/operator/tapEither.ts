...
export const tapEitherSync: {
  <A, B>(f: (a: A) => B): <R, E, E2>(self: Fx<R, E, Either.Either<E2, A>>) => Fx<R, E, Either.Either<E2, A>>
  <R, E, E2, A, B>(self: Fx<R, E, Either.Either<E2, A>>, f: (a: A) => B): Fx<R, E, Either.Either<E2, A>>
} = dualWithTrace(
  2,
  (trace) =>
