...
export const tapSome: {
  <A, R2, E2, B>(f: (a: A) => Effect.Effect<R2, E2, B>): <R, E>(fx: Fx<R, E, Option.Option<A>>) => Fx<R | R2, E | E2, A>
  <R, E, A, R2, E2, B>(fx: Fx<R, E, Option.Option<A>>, f: (a: A) => Effect.Effect<R2, E2, B>): Fx<R | R2, E | E2, A>
} = dualWithTrace(
  2,
  (trace) =>
...
class TapSomeFx<R, E, A, R2, E2, B> extends BaseFx<R | R2, E | E2, Option.Option<A>> {
  ...
  constructor(readonly fx: Fx<R, E, Option.Option<A>>, readonly f: (a: A) => Effect.Effect<R2, E2, B>) {
    super()
  }

  run(sink: Sink<E | E2, Option.Option<A>>) {
  ...
  static make = <R, E, A, R2, E2, B>(fx: Fx<R, E, Option.Option<A>>, f: (a: A) => Effect.Effect<R2, E2, B>) =>
    new TapSomeFx(fx, f)
}
