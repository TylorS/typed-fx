...
export const unrefineWith: {
  <E2, E, E3>(
    ...
    g: (e: E) => E3
  ): <R, A>(self: Fx<R, E, A>) => Fx<R, E2 | E3, A>
  <R, E, A, E2, E3>(self: Fx<R, E, A>, f: (defect: unknown) => Option.Option<E2>, g: (e: E) => E3): Fx<R, E2 | E3, A>
...
export const unrefine: {
  <E2, E>(f: (defect: unknown) => Option.Option<E2>): <R, A>(
    self: Fx<R, E, A>
  ) => Fx<R, E | E2, A>
